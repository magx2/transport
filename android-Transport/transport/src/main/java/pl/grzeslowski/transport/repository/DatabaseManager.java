...
public class DatabaseManager {
    ...
    private static List<Connection> sConnections = Arrays.asList(
            new Connection(Arrays.asList(sCities.get(0), sCities.get(5), sCities.get(6), sCities.get(7), sCities.get(8), sCities.get(9), sCities.get(10), sCities.get(11), sCities.get(12), sCities.get(13), sCities.get(1)), getRandomLocalTime(), sProviders.get(0)),
            new Connection(Arrays.asList(sCities.get(0), sCities.get(2)), getRandomLocalTime(), sProviders.get(1)),
            new Connection(Arrays.asList(sCities.get(2), sCities.get(3), sCities.get(4), sCities.get(5), sCities.get(6), sCities.get(7), sCities.get(8), sCities.get(9), sCities.get(10), sCities.get(11), sCities.get(12), sCities.get(13), sCities.get(1)), getRandomLocalTime(), sProviders.get(2)),
